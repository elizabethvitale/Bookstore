...
<%@ page session="false" %>
    ...
    <main>
      <div>
        <h1>Error page</h1>
	<p>Either one of your books is out of stock, or you are trying to order more books than we have in stock<p>
	<p>For example, we may have 2 "A" books in stock, but you are trying to order 3</p>
	<a href="/viewCart?"><button class="button" style="margin-right: 10px;">GO BACK TO SHOPPING CART</button></a>
    </main>
    <footer>
      <div>
