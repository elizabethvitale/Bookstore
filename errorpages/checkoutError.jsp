...
<%@ page session="false" %>
    ...
    <main>
      <div>
        <h1>Error page</h1>
	<p>Something went wrong! Make sure to type in correct input!</p>
	<a href="../index.jsp"><button class="button" style="margin-right: 10px;">GO BACK TO HOME SCREEN</button></a>
    </main>
    <footer>
      <div>
