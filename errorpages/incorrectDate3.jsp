...
<%@ page session="false" %>
    ...
    <main>
      <div>
        <h1>Error</h1>
	<p>The ending date of this promotion has already passed, please don't send an expired promotion</p>
	<a href="../admin/editpromotions.jsp"><button class="button" style="margin-right: 10px;">Go back to Add Promotion</button></a>
	</div>
    </main>
    <footer>
      <div>
