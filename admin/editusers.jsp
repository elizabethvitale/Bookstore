...
<main>
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Premote/Depromote</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td scope="row"><input type="text" value="Tina" /></td>
      <td scope="row"><input type="text" value="tinagiang@uga.edu" /></td>
      <td scope="row"><input type="text" value="Yes" /></td>
      <td scope="row"><button class="button">Depromote</td>
    </tr>
    <tr>
      <td scope="row"><input type="text" value="Julia" /></td>
      <td scope="row"><input type="text" value="juliascott@uga.edu" /></td>
      <td scope="row"><input type="text" value="No" /></td>
      <td scope="row"><button class="button">Promote</td>
    </tr>
    <tr>
      <td scope="row"><input type="text" value="Elizabeth" /></td>
      <td scope="row"><input type="text" value="elizabeth@uga.edu" /></td>
      <td scope="row"><input type="text" value="Yes" /></td>
      <td scope="row"><button class="button">Depromote</td>
    </tr>
  </tbody>
</table>
<a href="editusers.jsp"><button class="button"> Update </button></a>
</main>
<footer>
    <div>
